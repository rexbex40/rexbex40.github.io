...
$(document).ready(function() {
  ...
  var audio = new Audio('http://res.cloudinary.com/lhl/video/upload/v1518502331/Star_Wars_The_Force_Awakens_Original_CrawlIntro.mp3');
  audio.currentTime = 7;
  audio.play();
  
  $('.title-container').delay(3000).toggleClass('active');
  
  $('.title-container').delay(9000).css('opacity', '0');
  ...
  var textFader = setInterval(function(){
    var screenPosition = paragraph.getBoundingClientRect();
    console.log(screenPosition);
    position = screenPosition.top;
    if(position > 0 && position < 170){
      $("p").css("opacity", 0);
    }
